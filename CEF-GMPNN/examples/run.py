...
flags.DEFINE_integer('seed', 25, 'Random seed to set')
...
#    new_rng_key, rng_key = jax.random.split(rng_key)
    test_stats = collect_and_eval(
        ...
        new_rng_key,
        extras=common_extras)
    logging.info('(test from loss) algo %s : %s', FLAGS.algorithms[algo_idx], test_stats)
...
#    new_rng_key, rng_key = jax.random.split(rng_key)
    test_stats = collect_and_eval(
        ...
        new_rng_key,
        extras=common_extras)
    logging.info('(test last) algo %s : %s', FLAGS.algorithms[algo_idx], test_stats)
