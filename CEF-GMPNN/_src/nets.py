...
class Net(hk.Module):
  ...
  def _msg_passing_step(self,
    ...
    hiddens, output_preds_cand, hint_preds, lstm_state, bank = self._one_step_pred(
        inputs, cur_hint, mp_state.hiddens,
        batch_size, nb_nodes, mp_state.lstm_state,
        spec, encs, decs, repred, bank=mp_state.bank, step=i)
#    hiddens, output_preds_cand, hint_preds, lstm_state, bank = self._one_step_pred(
#        inputs, cur_hint, mp_state.hiddens,
#        batch_size, nb_nodes, mp_state.lstm_state,
#        spec, encs, decs, repred, mp_state.bank)
    ...
    new_mp_state = _MessagePassingScanState(  # pytype: disable=wrong-arg-types  # numpy-scalars
        ...
        hiddens=hiddens,
        lstm_state=lstm_state, bank=bank)
    ...
    accum_mp_state = _MessagePassingScanState(  # pytype: disable=wrong-arg-types  # numpy-scalars
        ...
        hiddens=None, lstm_state=None, bank=None)
  ...
  def __call__(self, features_list: List[_Features], repred: bool,
    ...
    for algorithm_index, features in zip(algorithm_indices, features_list):
      ...
      bank1 = jnp.zeros((batch_size, nb_nodes, self.hidden_dim))
      bank2 = jnp.zeros((batch_size, nb_nodes, self.hidden_dim))
      bank = [bank1, bank2]
      ...
      mp_state = _MessagePassingScanState(  # pytype: disable=wrong-arg-types  # numpy-scalars
          ...
          hiddens=hiddens, lstm_state=lstm_state, bank=bank)
  ...
  def _one_step_pred(
    ...
    for _ in range(self.nb_msg_passing_steps):
      nxt_hidden, nxt_edge, bank = self.processor(
          node_fts,
          edge_fts,
          graph_fts,
          adj_mat,
    ...
    return nxt_hidden, output_preds, hint_preds, nxt_lstm_state, bank
